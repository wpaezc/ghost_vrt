...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    await page.screenshot({path: pathScreenshotsTest+ `./${version}new_post.png`})
    ...
    await page.screenshot({path: pathScreenshotsTest+ `./${version}open_publish_popup.png`})
    await editor.publish()
    await page.screenshot({path: pathScreenshotsTest+ `./${version}finish_publishing.png`})
    ...
    await page.screenshot({path: pathScreenshotsTest+ `./${version}end.png`})
